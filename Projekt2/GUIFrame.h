...
class GUIFrame : public wxFrame
{
    ...
    public:
        GUIFrame( wxWindow* parent, int id = wxID_ANY, wxString title = wxT("DPLL SAT Solver"), wxPoint pos = wxDefaultPosition, wxSize size = wxSize( 481,466 ), int style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
